...
* trying to re-implement too much of the assignment
...
We've provided unit tests based on the example that we worked through
in class.  Before running your code on real data, make sure it passes
all of the unit tests.

```
MacBook-Air:knn cketelsen$ python tests.py
...
----------------------------------------------------------------------
...
This is an example of what your code should look like when it's working:
```
MacBook-Air:knn cketelsen$ python knn.py --limit 500
Data limit: 500
Done loading data
...
1.  Don't re-implement closest point data structures or median
    functions.
